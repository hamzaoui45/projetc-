...
public:
    ...
    void setupUi(QDialog *log)
    {
        ...
        log->resize(1201, 733);
        log->setStyleSheet(QString::fromUtf8("background-color: rgb(153, 217, 217)"));
        ...
        label_6->setGeometry(QRect(80, 190, 401, 151));
        QFont font;
...
""));
        ...
        label_11->setGeometry(QRect(160, -50, 171, 181));
        label_11->setPixmap(QPixmap(QString::fromUtf8(":/new/prefix1/Design_sans_titre__13_-removebg-preview.png")));
        ...
        speechOutput_2->setGeometry(QRect(292, 50, 181, 71));
