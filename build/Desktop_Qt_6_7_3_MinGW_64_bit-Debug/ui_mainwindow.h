...
"color: rgb(9, 9, 9);"));
        ...
        pb_ajouter->setGeometry(QRect(260, 370, 121, 41));
...
""));
        ...
        le_id_supp_col = new QLineEdit(tab_3);
        le_id_supp_col->setObjectName("le_id_supp_col");
        le_id_supp_col->setGeometry(QRect(410, 100, 351, 61));
        le_id_supp_col->setStyleSheet(QString::fromUtf8("background-color: rgb(254, 255, 255);"));
        lab_id_supp = new QLabel(tab_3);
        lab_id_supp->setObjectName("lab_id_supp");
        lab_id_supp->setGeometry(QRect(130, 100, 151, 61));
        lab_id_supp->setStyleSheet(QString::fromUtf8("background-color: rgb(231,255,200);"));
        pb_supprimer_col = new QPushButton(tab_3);
        pb_supprimer_col->setObjectName("pb_supprimer_col");
        pb_supprimer_col->setGeometry(QRect(370, 320, 161, 71));
        pb_supprimer_col->setStyleSheet(QString::fromUtf8("background-color: rgb(254, 255, 255);"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        lab_id_supp->setText(QCoreApplication::translate("MainWindow", "Identifiant", nullptr));
        pb_supprimer_col->setText(QCoreApplication::translate("MainWindow", "Supprimer", nullptr));
