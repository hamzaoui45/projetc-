...
""));
        ...
        lineEdit->setGeometry(QRect(50, 130, 321, 28));
        lineEdit->setMaxLength(32767);
        lineEdit_2 = new QLineEdit(frame);
        lineEdit_2->setObjectName("lineEdit_2");
        lineEdit_2->setGeometry(QRect(50, 230, 321, 28));
        lineEdit_2->setFrame(true);
        lineEdit_2->setEchoMode(QLineEdit::EchoMode::Password);
        pushButton = new QPushButton(frame);
        pushButton->setObjectName("pushButton");
        pushButton->setGeometry(QRect(200, 470, 121, 41));
...
"background: #05696b;"));
    ...
    void retranslateUi(QDialog *log)
    {
        ...
        lineEdit->setPlaceholderText(QCoreApplication::translate("log", "UserID", nullptr));
        lineEdit_2->setInputMask(QString());
        lineEdit_2->setText(QString());
        lineEdit_2->setPlaceholderText(QCoreApplication::translate("log", "Password", nullptr));
        pushButton->setText(QCoreApplication::translate("log", "Se connecter", nullptr));
